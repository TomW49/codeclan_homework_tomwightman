...
titanic_clean %>% 
  ggplot() +
  aes(x = class, fill = survived_flag) +
  geom_bar()
...
# a split of 80/20 was used as i have a 712 length data set, enough numbers to have a bigger split

# it looks closely balanced enough, 5% variance
```
...
titanic_test_predicitions <- titanic_test %>% 
  add_predictions(titanic_fit, type = "class")

titanic_test_predicitions %>% 
...
conf_mat <- titanic_test_predicitions %>% 
